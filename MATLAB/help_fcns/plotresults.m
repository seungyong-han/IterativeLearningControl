...
hold on
    ...
    text(iteration_number + xshift,error_history(nb)+yshift,['\textbf{', name, '}', char(10), 'Iteration number: ',...
        num2str(iteration_number), char(10), 'error: ', num2str(error_history(nb))],...
